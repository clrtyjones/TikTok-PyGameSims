...
class Ball:
    def __init__(self, x, y, vx, vy, color):
        ...
        self.vy = vy
        self.color = color
        self.trail = []  # List to store positions and colors for the trail
...
def handle_boundary_collision(ball):
    ...
    if dist + ball_radius > visible_inner_radius:
        ...
        # Change Color Of Ball For Every Collision
        ball.color = (random.randint(25, 255), random.randint(25, 255), random.randint(25, 255))
...
def update_trails():
    for ball in balls:
        ...
        ball.trail.append((ball.x, ball.y, trail_color))
